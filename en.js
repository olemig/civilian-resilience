// ═══════════════════════════════════════════════════════════════════════
// CIVIL RESILIENCY LAB  ·  Content  ·  data/i18n/en.js
// ═══════════════════════════════════════════════════════════════════════
//
...
LANGS.en = {
  ...
  offer: {
    ...
    cards: [
      ...
      { num: '03', title: 'Priority Reading Plan',  body: 'Every gap links to the exact chapter in the Civil Resiliency Lab book. Not vague advice — a personalised study list with specific page references.' },
  ...
  youtube: {
    ...
    intro:      'Thematic deep-dives on the Civil Resiliency Lab YouTube channel. Practical demonstrations — water filtration, the STOP protocol, crowd survival, and more.',
    videos: [
  ...
  calc: {
    ...
    btnBack:        '← Back',
    scanning:       'Scanning:',
    gapsSoFar:      '⚠ {n} gap(s) identified so far',
  },
  ...
  results: {
    ...
    bookCtaBody:         'Your personalised reading plan is ready — every answer is in the Civil Resiliency Lab guide.',
    bookCtaBtn:          'Get the Book on Amazon',
    btnSave:             'Save to Cabinet',
    btnRetake:           'Retake Assessment',
    btnIntel:            'Browse Intel Hub →',
    gapAlert:            '⚠ {n} domain(s) below the 70% readiness threshold — your priority reading plan is below.',
  },
...
<p>The 72-hour rule applies across all scenarios: for the first 72 hours, you rely entirely on your own resources. If the situation has not normalized after 72 hours — plan in weeks, not days.</p>`,
    ...
    // ── FEATURED 1 ────────────────────────────────────────────────────
    {
      ...
      title: 'The STOP Protocol: How to Break Out of Panic and Take Back Control',
...
<p>This is not panic. It is a temporary, reversible experiment with an asymmetric payoff. The cost of being wrong: one lost day. The cost of not doing it when it was real: potentially everything.</p>`,
    ...
    // ── GRID ARTICLE 10 ───────────────────────────────────────────────
    {
      id: 10, cat: 'energy', catL: 'Energy', ch: 'Ch. 5.1 & 7.4', time: '6 min',
...
<p><strong>Paper and pen.</strong> Irreplaceable. Notes, supply tracking, lists, messages left at rally points. A logbook kept during a crisis has documented survival decisions in every prolonged scenario from Leningrad to Sarajevo to COVID lockdowns.</p>`,
  ...
  library: {
    label:       'Downloads',
    heading:     'LIBRARY',
    sub:         'Printable tools, workbooks and reference cards from the Civil Resiliency Lab framework. Sign in once to access everything — free.',
    ...
    workbookTitle: 'Civil Resiliency Lab — Workbook',
